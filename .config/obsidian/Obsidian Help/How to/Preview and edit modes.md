...
If you want to default to opening in preview rather than edit mode, a toggle for that can be found in the [[Command palette]]. You can also set a [[Keyboard shortcuts|Keyboard Shortcut]] for toggling between default states.
